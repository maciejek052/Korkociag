...
const SearchSummaryScreen = ({ route, navigation }) => {
    ...
    return (
        <View style={styles.root}>
            ...
            <Text style={styles.heading}>Potwierdź wyszukiwanie</Text>
            <Text style={styles.text}>Upewnij się, czy poprawnie wprowadziłeś szczegóły wyszukiwanych korepetycji</Text>
            <>
