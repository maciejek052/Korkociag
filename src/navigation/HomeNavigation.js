...
import ChatScreen from '../screens/LessonScreen/ChatScreen';
...
const HomeNavigation = () => {
    return <Stack.Navigator>
        ...
        <Stack.Screen name="MapScreen" component={MapScreen} options={{ headerShown: true, headerTitle: "Mapa" }} />
        <Stack.Screen name="EditLessonScreen" component={EditLessonScreen} options={{ headerShown: false }} />
        <Stack.Screen name="ChatScreen" component={ChatScreen} options={{ headerShown: true, headerTitle: "Czat" }} />
    </Stack.Navigator>
